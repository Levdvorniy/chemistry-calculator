...
def get_periodic_table():
    ...
    manganese = Element(25, "Manganese", "Manganum", "Mn", [2, 3, 4, 6, 8], [ElementsType.METAL], 4, 4, 7)
    Elements.append(manganese)
    iron = Element(26, "Iron", "Ferrum", "Fe", [2, 3, 8], [ElementsType.METAL], 4, 4, 8)
    Elements.append(iron)
    cobalt = Element(27, "Cobalt", "Cobaltum", "Co", [2, 3], [ElementsType.METAL], 4, 4, 8)
    Elements.append(cobalt)
    nickel = Element(28, "Nickel", "Nickelum", "Ni", [2, 3, 4], [ElementsType.METAL], 4, 4, 8)
    ...
    bromine = Element(35, "Bromine", "Bromum", "Br", [1, 3, 5, 7], [ElementsType.NONMETAL], 4, 5, 7)
    Elements.append(bromine)
    krypton = Element(36, "Krypton", "Krypton", "Kr", [2, 4, 6], [ElementsType.NONMETAL], 4, 5, 8)
    ...
    zirconium = Element(40, "Zirconium", "Zirconium", "Zr", [2, 3, 4], [ElementsType.METAL], 5, 6, 4)
    Elements.append(zirconium)
    niobium = Element(41, "Niobium", "Niobium", "Nb", [1, 2, 3, 4, 5], [ElementsType.METAL], 5, 6, 5)
    ...
    technetium = Element(43, "Technetium", "Technetium", "Tc", [1, 2, 3, 4, 5, 6, 7], [ElementsType.METAL], 5, 6, 7)
    Elements.append(technetium)
    ruthenium = Element(44, "Ruthenium", "Ruthenium", "Ru", [2, 3, 4, 5, 6, 7, 8], [ElementsType.METAL], 5, 6, 8)
    Elements.append(ruthenium)
    rhodium = Element(45, "Rhodium", "Rhodium", "Rh", [1, 2, 3, 4, 5], [ElementsType.METAL], 5, 6, 8)
    Elements.append(rhodium)
    palladium = Element(46, "Palladium", "Palladium", "Pd", [1, 2, 3, 4], [ElementsType.METAL], 5, 6, 8)
    Elements.append(palladium)
    silver = Element(47, "Silver", "Argentum", "Ag", [1, 2, 3], [ElementsType.METAL], 5, 7, 1)
    ...
    xenon = Element(54, "Xenon", "Xenon", "Xe", [2, 4, 6, 8], [ElementsType.NONMETAL], 5, 7, 8)
    Elements.append(xenon)
    cesium = Element(55, "Cesium", "Caesium", "Cs", [3, 4], [ElementsType.METAL], 6, 8, 1)
    ...
    tantalum = Element(73, "Tantalum", "Tantalum", "Ta", [1, 2, 3, 4, 5], [ElementsType.METAL], 6, 8, 5)
    ...
    rhenium = Element(75, "Rhenium", "Rhenium", "Re", [1, 2, 3, 4, 5, 6, 7], [ElementsType.METAL], 6, 8, 7)
    Elements.append(rhenium)
    osmium = Element(76, "Osmium", "Osmium", "Os", [2, 3, 4, 5, 6, 8], [ElementsType.METAL], 6, 8, 8)
    Elements.append(osmium)
    iridium = Element(77, "Iridium", "Iridium", "Ir", [1, 2, 3, 4, 5, 6], [ElementsType.METAL], 6, 8, 8)
    Elements.append(iridium)
    platinum = Element(78, "Platinum", "Platinum", "Pt", [1, 2, 3, 4, 5], [ElementsType.METAL], 6, 8, 8)
    Elements.append(platinum)
    gold = Element(79, "Gold", "Aurum", "Au", [1, 2, 3], [ElementsType.METAL], 6, 9, 1)
    Elements.append(gold)
    mercury = Element(80, "Mercury", "Hydrargyrum", "Hg", [2], [ElementsType.METAL], 6, 9, 2)
    ...
    polonium = Element(84, "Polonium", "Polonium", "Po", [2, 4, 6], [ElementsType.METAL], 6, 9, 6)
    Elements.append(polonium)
    astatine = Element(85, "Astatine", "Astatine", "At", [0], [ElementsType.NONMETAL], 6, 9, 7)
